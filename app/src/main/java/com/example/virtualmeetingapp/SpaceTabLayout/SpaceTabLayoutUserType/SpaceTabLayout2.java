...
public class SpaceTabLayout2 extends RelativeLayout {
    ...
    public SpaceTabLayout2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
        initArrts(attrs);
    }

    public SpaceTabLayout2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        defaultTabFiveButtonIcon = getContext().getResources().getDrawable(R.drawable.chat);
    ...
    private void initArrts(AttributeSet attrs) {
        ...
        for (int i = 0; i < a.getIndexCount(); ++i) {
            ...
            } else if (attr == R.styleable.SpaceTabLayout1_icon_four) {
                if (numberOfTabs > 3)
                    defaultTabFourButtonIcon = a.getDrawable(attr);

            } else if (attr == R.styleable.SpaceTabLayout1_icon_five) {
                if (numberOfTabs > 4)
